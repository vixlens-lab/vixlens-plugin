...
| FREEVIX VS | `#00497A` | null | **-4.00** | null |
...
**Duas famílias param em -4.00**, contra -6.00 de todas as outras: Vix Total e Freevix VS. São as duas de entrada de cada linha (multifocal e visão simples). Na matriz do índice, marque o cilindro delas em `#C81E1E` Bold — é a diferença que mais gera pedido errado no balcão.
...
**Freevix VS** é a de entrada da linha de visão simples, conferida contra o tabelão `tabelona_vixlens_2026_digital_v16` (página 13, logo antes da VS HD), onde a página se chama "Visão Simples". Vem no CSV como as outras. Exports gerados até 02/09/2026 trazem 12 famílias e não a incluem — se estiver trabalhando com um desses, peça o export atualizado em vez de montar a página na mão.
